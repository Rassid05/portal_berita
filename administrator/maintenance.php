...
<body>
    ...
    <div class="maintenance-container animate__animated animate__fadeIn">
        ...
        <div class="contact animate__animated animate__fadeIn animate__delay-3s">
            ...
            <strong><i class="fas fa-envelope"></i> rassiddical@gmail.com</strong><br>
            <strong><i class="fas fa-phone"></i> +62 822 9405 3620</strong>
        </div>
        ...
        function startTimer(duration, display) {
            ...
            var interval = setInterval(function () {
                ...
                if (--timer < 0) {
                    ...
                    document.querySelector('.countdown').classList.add('animate__animated', 'animate__pulse', 'animate__infinite');
                }
            }, 1000);
        }
