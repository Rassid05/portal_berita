                ...
                <div class="card-body">
                    <form action="?page=unggah" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" class="form-control" id="author" placeholder="Masukkan author berita">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="konten" id="konten" rows="8" placeholder="Tulis konten berita di sini..."></textarea>
                        </div>
